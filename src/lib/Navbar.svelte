...
<navbar class="block lg:container <lg:m-4 m-5 flex flex-wrap items-center space-x-8">
    ...
    <div class="icons md:(absolute left-1/2 justify-center -translate-x-1/2) transform flex">
