...
<SettingPart>
    ...
    <input bind:value={$config.port} slot="input" type="number" min={0} max={65529} placeholder={"47789"} class="h-10 border-gray-300 border-1 pl-4 rounded-lg w-24" />
</SettingPart>
<SettingPart>
    ...
    <input bind:value={$config.fec_percentage} slot="input" type="number" min={0} placeholder={"20"} class="h-10 border-gray-300 border-1 pl-4 rounded-lg w-24" />
</SettingPart>
<SettingPart>
    ...
    <input bind:value={$config.channels} slot="input" type="number" min={1} placeholder={"1"} class="h-10 border-gray-300 border-1 pl-4 rounded-lg w-24" />
</SettingPart>