...
<div class="flex items-center">
    ...
    <div class="inline-flex rounded-lg overflow-hidden border mt-4 border-gray-300">
        <button on:click={() => encoder = 'software'} class="flex flex-col items-center justify-center transition-colors gap-2 h-24 w-24 border-r border-gray-300 {encoder === 'software' ? 'bg-blue-500 text-white' : 'bg-white hover:bg-gray-100'}">
        ...
        <button on:click={() => encoder = 'amd'} class="flex flex-col items-center justify-center transition-colors gap-2 h-24 w-24 border-r border-gray-300 {encoder === 'amd' ? 'bg-red-500 text-white' : 'bg-white hover:bg-gray-100'}">
        ...
        <button on:click={() => encoder = 'nvidia'} class="flex flex-col items-center justify-center transition-colors gap-2 h-24 w-24 {encoder === 'nvidia' ? 'bg-green-500 text-white' : 'bg-white hover:bg-gray-100'}">
