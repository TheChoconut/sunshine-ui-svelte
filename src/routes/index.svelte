...
<content>
  ...
  <a href="https://github.com/SunshineStream/sunshine" rel="external" class="inline-flex transition-all items-center px-12 bg-gray-200 hover:(ring-2 ring-offset-4 ring-offset-gray-100 ring-gray-600) rounded-lg">
    <div class="w-16 h-16"><DiGithubBadge /></div>
